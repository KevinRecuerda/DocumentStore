namespace DocumentStore.Extensions
{
    ...
    public static class MartenRegistryExtensions
    {
        ...
        public static StoreOptions GinIndex<T>(this StoreOptions options, Expression<Func<T, object>> expression, string op = "")
        {
            return options.Index(expression, IndexMethod.gin, op);
        }
